...
import imgHeaderIndustries from '../Assets/images/data-science.jpg';
  ...
  <header id="home" 
   style={{
    ...
    transform: 'translateZ(0)'
      ...
      <div class="section1__container header1__container">
        <div class="header1__content">
          ...
          <h1 class="section1__header">Make a decision and take decisive action by utilizing data science.!
          </h1>
        </div>
    ...
    <section class="about1">
      ...
      <h3 style={{color:'white'}} class="section__subheader">Data Sciences</h3>
        <div class="about1__content about1__content-1">
          
          <h2 class="section1__header">AI for enhanced and independent decision-making</h2>

          <p>Algorithms that can comprehend certain business settings, train on the proper data, update themselves in real-time, learn from past experiences, and involve humans in the process are necessary for developing trustworthy AI/ML decisioning systems. Collaboration between several disciplines and cross-functional competencies are required to make this possible.

We combine these qualities to make AI a useful instrument for decision-making in a variety of contexts. Our solutions span from completely self-sufficient real-time decision-making systems to predictive intelligence designed to enhance human decision-making.
          </p>
        ...
        <div class="about1__content about1__content-2">
          ...
          <h2 class="section1__header">Predictive ML</h2>
          <p>Utilize both structured and unstructured data to forecast future trends, choices about prices, risks associated with fraud, attrition of customers, etc.
          </p>
          <div class="about1__btn">
            <Link to="#">
              Read more
        ...
        <div class="about1__content about1__content-3">
          ...
          <h2 class="section1__header">Predicting</h2>
          <p>Utilize cost planning, shipment forecasting, granular sales, demand forecasting, and other techniques to propel better operations and planning.
          </p>
          <div class="about1__btn">
            <Link to="#">
              Read more
        ...
        <div class="about1__content about1__content-4">
          ...
          <h2 class="section1__header">Self-governing systems</h2>
          <p>Modern algorithms that function without the need for human intervention, such as those used in real-time bidding, recommender systems, IoT sensor data-based activities, and advertising interventions.
          </p>
          <div class="about1__btn">
            <Link to="#">
              Read more
