  ...
  <header class="header1" id="home" 
   style={{
    ...
    transform: 'translateZ(0)'
      ...
      <div class="section1__container header1__container">
        <div class="header1__content">
          ...
          Revolutionizing the manufacturing industry through intelligent insights!
          </h1>
        </div>
    ...
    <section class="about1">
      ...
      <h3 style={{color:'white'}} class="section__subheader">Manufacturing</h3>
        <div class="about1__content about1__content-1">
          
          <h2 class="section1__header">Achieve manufacturing excellence: Reduce costs and stimulate growth.</h2>
          <p>
          For our clients, the intersection of competitive dynamics, B2B trends that are changing, technology breakthroughs, and macroeconomic pressures offers both opportunities and problems. Producers are working to build robust supply networks while constantly under pressure to improve their products at lower costs and higher profit margins. The transformation activities of these firms are centered around strategic objectives including Industry 4.0, digital commerce, connected products and services, and intelligent operations. For each of these projects, decision-making and execution speed are critical components. Success depends on taking timely action on data-driven business insights,
           highlighting the critical role that analytics and AI play.
          </p>
        ...
        <div class="about1__content about1__content-2">
          ...
          <h2 class="section1__header">Enhance operational efficiency through remote monitoring and instantaneous maintenance solutions.</h2>
          <p>
          Leverage advanced data integration and analysis techniques to harness insights from a variety of sensors, equipment, and production systems, accurately predicting maintenance requirements. Through real-time monitoring of machine performance and pattern detection, AI can proactively identify potential equipment failures, 
          facilitating timely maintenance actions and mitigating costly downtime.
          </p>
          <div class="about1__btn">
            <Link to="#">
              Read more
        ...
        <div class="about1__content about1__content-3">
          ...
          <h2 class="section1__header">
Implement quality control and testing processes driven by computer vision technology to ensure precision and accuracy in manufacturing operations.</h2>
          <p>
          Make use of computer vision to quickly and accurately identify faults in products by carefully inspecting them. This method reduces waste and improves overall product quality by meeting strict quality criteria. Improve efficiency and efficacy by streamlining testing procedures using a data-driven optimization strategy.
          </p>
          <div class="about1__btn">
            <Link to="#">
              Read more
