...
import slider2 from '../Assets/images/services_3.jpg';
  ...
  <div className="left-aligned" style={{ paddingTop: '50px', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <div style={{ flex: '1', textAlign: 'center' }}>
        <div>
          <h1><b>Business Intelligence</b></h1>
          <hr />
          <br/>
          ...
          <br/>
            ...
            <br/>
          <p className='para'>A modern business intelligence (BI) solution takes into account the needs of key stakeholders, the maturity of your data, and the state of your technology ecosystem in order to prioritize the delivery of actionable insights and value generation. In order to enable business users to access and understand data, Tiger Analytics BI solution places a strong emphasis on user-centric design and execution. 
